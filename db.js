...
const mysqlSession = require("express-mysql-session")(session) // Dependências para criar a sessão do usuário
...
async function makeSession(app,opt){  // Cria a sessão do usuário
